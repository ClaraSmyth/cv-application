...
class Preview extends Component {
  ...
  render() {
    const { userDetails, contactDetails, education, experience, skills, references, canvas, themeColour } =
      this.props.details;
    return (
      <div id="save-node" className={`preview-container ${themeColour}-theme`}>
